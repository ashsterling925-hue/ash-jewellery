        ...
        <div className="container max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-14 items-start">
            ...
            <div className="flex flex-col justify-start">
              ...
              {/* Big Gold/Amber Button: Enquire on WhatsApp */}
              <button
                type="button"
                onClick={handleWhatsAppEnquiry}
                className="w-full py-3.5 px-6 rounded-md bg-[#e89814] hover:bg-[#d68b12] text-white font-semibold text-sm tracking-wide flex items-center justify-center gap-2 shadow-sm transition-all duration-200 cursor-pointer active:scale-[0.99]"
              >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.911.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766 0-3.187-2.59-5.771-5.764-5.771zm3.392 8.244c-.144.405-.837.774-1.17.824-.312.045-.694.076-2.22-.553-1.821-.75-2.996-2.6-3.087-2.72-.09-.12-1.028-1.368-1.028-2.61 0-1.242.646-1.854.877-2.107.231-.253.504-.316.672-.316.168 0 .336.003.483.011.157.008.366-.06.573.438.21.504.714 1.745.777 1.872.063.126.105.273.021.441-.084.168-.126.273-.252.42-.126.147-.266.329-.38.441-.126.126-.258.263-.111.515.147.252.654 1.077 1.403 1.744.965.859 1.78 1.124 2.032 1.25.252.126.399.105.546-.063.147-.168.63-.735.798-.987.168-.252.336-.21.567-.126.231.084 1.47.693 1.722.819.252.126.42.189.483.294.063.105.063.609-.081 1.014z" />
                </svg>
              </button>
